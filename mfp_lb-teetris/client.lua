local identifier = "mfp-lb-teetris"
...
CreateThread(function ()
    ...
    local function AddApp()
        local added, errorMessage = exports["lb-phone"]:AddCustomApp({
            ...
            size = Config.size, 
            price = Config.price, 
            images = {"https://r2.fivemanage.com/pub/zbjrw93sbzoc.png", "https://r2.fivemanage.com/pub/iaria8bppswk.png", "https://r2.fivemanage.com/pub/y43b56ccbclo.png"}, -- OPTIONAL array of images for the app on the app store
